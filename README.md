...
```txt
- начинаем в 20:00 по средам (можно заходить чуточку заранее)  
...
- выбрать - через "Браузер"  
- лучше использовать для этого кабинета Yandex-браузер или Google Chrome  
- а для всего остального можно использовать любой браузер по желанию  
```  

### Наши занятия по дням и по темам  
...
> [учебники](https://disk.yandex.ru/d/YxOIRcpmK935vw)  
